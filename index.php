      ...
      <div class="container">
        <div class="row">
          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
            <h3><i class="fa fa-rocket description-icon"></i><?=_("Launch your project");?></h3>
          ...
          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
            <h3><i class="fa fa-credit-card description-icon"></i><?=_("Donate for <i class=\"fa fa-heart\"></i>");?></h3>
          ...
          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
            <h3><i class="fa fa-users description-icon"></i><?=_("Everyone collaborates");?></h3>
          ...
          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
            <h3><i class="fa fa-graduation-cap description-icon"></i><?=_("Learn and teach");?></h3>
          ...
          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
            <h3><i class="fa fa-cube description-icon"></i><?=_("Manage with the best");?></h3>
          ...
          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
            <h3><i class="fa fa-github description-icon"></i><?=_("Open Source");?></h3>
