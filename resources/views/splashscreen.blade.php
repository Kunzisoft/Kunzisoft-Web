...
@section('content')
      <div id="tophome" class="splash">
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-8 splash-form col-content-center">
              ...
              <form action="https://kunzisoft.hosted.phplist.com/lists/?p=subscribe&amp;id=1" method="post" id="phplistsubscribeform">
                <input type="text" class="form-control" name="email" value="" id="emailaddress" />
                <button class="btn btn-primary" type="submit" id="phplistsubscribe">Subscribe</button>
              </form>
            </div>
          </div>
        </div>
      ...
      <div class="description-content">
        <div class="container">
          <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 col-content-center">
        ...
        <div class="container">
            <div class="row">
              <div class="col-lg-12 col-content-center">
                ...
                <a class="btn btn-danger" target="_blank" href="http://kunzisoft.blogspot.fr/2016/10/centralisation-des-nouveaux-projets.html" title="Ask community"><i class="fa fa-flask"></i> Submit features</a>
              </div>
            </div>
        </div>
      </div>
        ...
        <div class="container">
            <div class="row">
              <div class="col-lg-12 col-content-center">
                ...
                <a class="btn btn-primary" target="_blank" href="https://github.com/Kunzisoft" title="Ask community"><i class="fa fa-gear"></i> Contribute</a>
              </div>
            </div>
        </div>
      </div>
        ...
        <div class="container">
            <div class="row">
              <div class="col-lg-12 col-content-center">
                ...
                <button class="btn btn-primary" title="Donate" disabled><i class="fa fa-heart"></i> Donate (Coming soon)</button>
              </div>
            </div>

            <div class="row">
              <div class="col-lg-6 col-sm-6 section-title col-content-center">
                <h3><strong>Kunzisoft</strong> project need donators</h3>
              </div>
              <div class="col-lg-6 col-sm-6 section-title col-content-center">
                <h4>Goal : <strong>1000 €</strong></h4>
              </div>
              <div class="col-sm-12 col-lg-12 col-content-center">
                ...
                <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                  ...
                  ">
                  <button class="btn btn-success" type="submit" value="Donate" name="submit" title="PayPal - The safer, easier way to pay online!"><i class="fa fa-heart"></i> Donate</button>
                </form>
              </div>
            </div>
                ...
                <div class="carousel-inner" role="listbox">
                  <div class="item active">
                    <div class="row">
                      ...
                      <div class="col-lg-4 col-sm-4 col-content-center">
                        <div class="preview">
                          <div class="image">
                          ...
                          <div class="options">
                            ...
                            <div>
                              <a class="btn btn-primary" target="_blank" href="https://www.mozilla.org/contribute/"><i class="fa fa-gear"></i> Contribute</a>
                              <a class="btn btn-success" target="_blank" href="https://www.mozilla.org/"><i class="fa fa-heart"></i> Donate</a>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-lg-4 col-sm-4 col-content-center">
                        <div class="preview">
                          ...
                          <div class="options">
                            ...
                            <p>Office suite</p>
                            <div>
                              <a class="btn btn-primary" target="_blank" href="https://libreoffice.org/community/get-involved/"><i class="fa fa-gear"></i> Contribute</a>
                              <a class="btn btn-success" target="_blank" href="https://libreoffice.org/donate/"><i class="fa fa-heart"></i> Donate</a>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-lg-4 col-sm-4 col-content-center">
                        <div class="preview">
                          ...
                          <div class="options">
                            ...
                            <div>
                              <a class="btn btn-primary" target="_blank" href="https://fr.wikipedia.org/wiki/Contributions/"><i class="fa fa-gear"></i> Contribute</a>
                              <a class="btn btn-success" target="_blank" href="https://donate.wikimedia.org"><i class="fa fa-heart"></i> Donate</a>
                            </div>
                          </div>
                        </div>
                      </div>
